        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={contentRef} className="text-white">
            ...
            <p ref={textRef} className="text-gray-300 text-lg mb-8 leading-relaxed">
              Software Readvanced is a web application (PWA) designed to help students learn the new HSC software engineering course, by providing useful learning resources to students for their studies.
            </p>
